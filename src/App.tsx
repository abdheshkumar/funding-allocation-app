...
const funders: Funder[] = [
  { id: 'f1', name: 'Funder 1', startDate: new Date(2025, 0, 1), endDate: new Date(2025, 9, 31), amount: 2000 },
  { id: 'f2', name: 'Funder 2', startDate: new Date(2025, 0, 1), endDate: new Date(2025, 9, 31), amount: 2000 },
  { id: 'f3', name: 'Funder 3', startDate: new Date(2025, 4, 1), endDate: new Date(2025, 10, 30), amount: 1000 },
  { id: 'f4', name: 'Funder 4', startDate: new Date(2025, 0, 1), endDate: new Date(2025, 11, 30), amount: 1000 },
];
...
const App: React.FC = () => {
  ...
  return (
    <div className="App">
      ...
      <FunderTable funders={funders.map(f => ({
        ...f,
